...
{
    [TestFixture]
    public class AbstractLogicApiTests
    {
        public class MockLogicApi : AbstractLogicApi
        {
            internal override IEnumerable<Ball> Balls => new List<Ball>();
            ...
            public override void SpawnBalls(int ballNumber) { }
        ...
        [Test]
        public void AbstractLogicApi_SpawnBalls()
        {
            // Przygotowanie mocka klasy podrzędnej
            var logicApiMock = new Mock<MockLogicApi>();

            // Ustawienie zachowania mocka
            logicApiMock.Setup(api => api.SpawnBalls(It.IsAny<int>()));

            // Wywołanie metody
            logicApiMock.Object.SpawnBalls(5);

            // Weryfikacja zachowania
            logicApiMock.Verify(api => api.SpawnBalls(5), Times.Once);
        }
    }
}
